...
{{-- Modal Edit --}}
<div class="modal fade" id="editNilaiModal{{ $sbdp->id }}" tabindex="-1" aria-labelledby="editsbdpModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form name="edit_data" action="{{ url('/nilai/sbdp/update/'.$sbdp->id) }}" method="post" enctype="multipart/form-data">
            <div class="modal-header">
                        ...
                        @csrf 
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">NISN</label>
                                        <input id="nisn" class="form-control @error('nisn') is-invalid @enderror" type="number" name="nisn" placeholder="Masukkan NISN" value="{{ $sbdp->nisn }}">
                                        @error('nisn')
                                            <div class="alert alert-danger mt-2">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-md-7">
                                  <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Kelas</label>
                                    <input id="kelas" class="form-control @error('kelas') is-invalid @enderror" type="text" placeholder="Kelas" name="kelas" value="{{ $sbdp->kelas }}">
                                    @error('kelas')
                                            <div class="alert alert-danger mt-2">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Nama Siswa</label>
                                        <input id="nama_siswa" class="form-control @error('nama_siswa') is-invalid @enderror" name="nama_siswa" type="text" placeholder="Masukkan Nama Siswa" value="{{ $sbdp->nama_siswa }}">
                                        @error('nama_siswa')
                                            <div class="alert alert-danger mt-2">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-md-4">
                                  <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Nilai PH 1</label>
                                    <input id="ph1" class="form-control @error('ph1') is-invalid @enderror" type="number" placeholder="Masukkan Nilai PH 1" name="ph1" value="{{ $sbdp->ph1 }}">
                                    @error('ph1')
                                        <div class="alert alert-danger mt-2">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-md-4">
                                  <div class="form-group">
                                      <label for="example-text-input" class="form-control-label">Nilai PH 2</label>
                                      <input id="ph2" class="form-control @error('ph2') is-invalid @enderror" type="number" placeholder="Masukkan Nilai PH 2" name="ph2" value="{{ $sbdp->ph2 }}">
                                      @error('ph2')
                                          <div class="alert alert-danger mt-2">
                                              {{ $message }}
                                          </div>
                                ...
                                <div class="col-md-4">
                                  <div class="form-group">
                                      <label for="example-text-input" class="form-control-label">Nilai PH 3</label>
                                      <input id="ph3" class="form-control @error('ph3') is-invalid @enderror" type="number" placeholder="Masukkan Nilai PH 3" name="ph3" value="{{ $sbdp->ph3 }}">
                                      @error('ph3')
                                          <div class="alert alert-danger mt-2">
                                              {{ $message }}
                                          </div>
                                ...
                                <div class="col-md-4">
                                  <div class="form-group">
                                      <label for="example-text-input" class="form-control-label">Nilai PH 4</label>
                                      <input id="ph4" class="form-control @error('ph4') is-invalid @enderror" type="number" placeholder="Masukkan Nilai PH 4" name="ph4" value="{{ $sbdp->ph4 }}">
                                      @error('ph4')
                                          <div class="alert alert-danger mt-2">
                                              {{ $message }}
                                          </div>
                                ...
                                <div class="col-md-4">
                                  <div class="form-group">
                                      <label for="example-text-input" class="form-control-label">Nilai PH 5</label>
                                      <input id="ph5" class="form-control @error('ph5') is-invalid @enderror" type="number" placeholder="Masukkan Nilai PH 5" name="ph5" value="{{ $sbdp->ph5 }}">
                                      @error('ph5')
                                          <div class="alert alert-danger mt-2">
                                              {{ $message }}
                                          </div>
                                ...
                                <div class="col-md-4">
                                  <div class="form-group">
                                      <label for="example-text-input" class="form-control-label">Nilai PH 6</label>
                                      <input id="ph6" class="form-control @error('ph6') is-invalid @enderror" type="number" placeholder="Masukkan Nilai PH 6" name="ph6" value="{{ $sbdp->ph6 }}">
                                      @error('ph6')
                                          <div class="alert alert-danger mt-2">
                                              {{ $message }}
                                          </div>
                                ...
                                <div class="col-md-4">
                                  <div class="form-group">
                                      <label for="example-text-input" class="form-control-label">Nilai PH 7</label>
                                      <input id="ph7" class="form-control @error('ph7') is-invalid @enderror" type="number" placeholder="Masukkan Nilai PH 7" name="ph7" value="{{ $sbdp->ph7 }}">
                                      @error('ph7')
                                          <div class="alert alert-danger mt-2">
                                              {{ $message }}
                                          </div>
                                ...
                                <div class="col-md-4">
                                  <div class="form-group">
                                      <label for="example-text-input" class="form-control-label">Nilai PH 8</label>
                                      <input id="ph8" class="form-control @error('ph8') is-invalid @enderror" type="number" placeholder="Masukkan Nilai PH 8" name="ph8" value="{{ $sbdp->ph8 }}">
                                      @error('ph8')
                                          <div class="alert alert-danger mt-2">
                                              {{ $message }}
                                          </div>
                                ...
                                <div class="col-md-4">
                                  <div class="form-group">
                                      <label for="example-text-input" class="form-control-label">Nilai PH 9</label>
                                      <input id="ph9" class="form-control @error('ph9') is-invalid @enderror" type="number" placeholder="Masukkan Nilai PH 9" name="ph9" value="{{ $sbdp->ph9 }}">
                                      @error('ph9')
                                          <div class="alert alert-danger mt-2">
                                              {{ $message }}
                                          </div>
...
{{-- DeleteModal  --}}
<div class="modal fade" id="deleteNilaiModal{{ $sbdp->id }}" tabindex="-1" aria-labelledby="deleteNilaiLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
          <div class="modal-header">
          ...
          <div class="modal-body">
            <div class="mb-2">
              Apakah anda yakin akan menghapus data <strong>{{ $sbdp->nama_siswa }}</strong>?
            </div>
            <br>
            <div class="modal-footer mb-0">
              <button type="button" class="btn btn-default" data-bs-dismiss="modal">Close</button>
              <a href="{{url('/nilai/sbdp/'. $sbdp->id .'/hapus')}}">
