...
<div class="modal fade" id="editNilaiModal{{ $inggris->id }}" tabindex="-1" aria-labelledby="editinggrisModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form name="edit_data" action="{{ url('/nilai/bhs_inggris/update/'.$inggris->id) }}" method="post" enctype="multipart/form-data">
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="modal-footer mb-0">
              ...
              <a href="{{url('/nilai/bhs_inggris/'. $inggris->id .'/hapus')}}">
