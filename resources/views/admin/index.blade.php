        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="align-middle">
              <a data-bs-toggle="modal" data-bs-target="#editStatusModal{{ $u->nisn }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                Edit
              </a>
            </td>
            <td class="align-middle">
